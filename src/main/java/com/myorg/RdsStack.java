...
public class RdsStack extends Stack {
    ...
    public RdsStack(final Construct scope, final String id, final StackProps props, Vpc vpc) {
        ...
        //captura dos parametros da stack no cdk
        ...
        // habilita portas para o banco de dados no securitygroup

        ISecurityGroup iSecurityGroup = SecurityGroup.fromSecurityGroupId(this, id,
                vpc.getVpcDefaultSecurityGroup());
        iSecurityGroup.addIngressRule(Peer.anyIpv4(), Port.tcp(3306));

        DatabaseInstance databaseInstance = DatabaseInstance.Builder
                .create(this, "Rds01")
                .instanceIdentifier("aws-prject01-db")
